...
namespace TireDataAnalyzer.TexEquation
{
    ...
    public partial class MagicFormula_TexEquation : UserControl
    {
        ...
        string[] FY = {
            @"{F_y} = D\, \sin(C \arctan(B(SA + S_h) - E(B(SA + S_h)  - \arctan B(SA+ S_h) ))) + S_v",
            @"{C} = {a_0}",
        ...
        string[] CFX = {
            @"{combF_x} = {F_x}{G_x}\,\,,{G_x} = \frac {\cos \left(C\,\arctan \left(B\,\left(SA+{ S_h}\right) - E\,\left(B\,\left(SA+{ S_h}\right)- \arctan \left(B\,\left(SA+{ S_h}\right)\right)\right)\right)\right)} {\cos \left(C\,\arctan \left(B\,{ S_h} -E\, \left(B\,{ S_h}-\arctan \left(B\,{ S_h}\right)\right)\right)\right)}",
            @"{C} = {b_3}",
        ...
        string[] CFY = {
            @"{combF_y} = {F_y}{G_y}+{S_v}\,\,,{G_y} = \frac {\cos \left(C\,\arctan \left(B\,\left(SR+{ S_h}\right) - E\,\left(B\,\left(SR+{ S_h}\right)- \arctan \left(B\,\left(SR+{ S_h}\right)\right)\right)\right)\right)} {\cos \left(C\,\arctan \left(B\,{ S_h} -E\, \left(B\,{ S_h}-\arctan \left(B\,{ S_h}\right)\right)\right)\right)}",
            @"{C} = {b_{12}}",
            @"{B} = \frac{{{ b_9}\,{ IA}^2+{ b_8}}}{ {\sqrt{{ b_{10}}^2\, \left({ SA}-{ b_{11}}\right)^2+1}}}",
            @"{E}=  {b_{13}}+{b_{14}}\,FZ",
            @"{S_h}= \left({ b_7}\,{ FZ}+{ b_6}\right)\,{ IA}",
            @"{S_v}= \frac{{{D_{pure}}\,{ FZ}\,\left({ b_2}\,{ IA}+{ b_1}\,{ FZ}+ { b_0}\right)\,\sin \left({ b_4}\,\arctan \left({ b_5}\,{ IA}\right)\right)}}{{\sqrt{{ b_3}^2\,{ SA}^2+1}}}",
        };
        ...
        public void Control_Resize(object sender, EventArgs e)
        {
            ...
            for(int i=0; i<elementHost.Count(); ++i)
            {
                ...
                {
                    //formulaControl[i].Dispatcher.BeginInvoke(
                    //DispatcherPriority.Background,
                    //new Action(() =>{
                    --formulaControl[i].Scale;
                    if (formulaControl[i].Scale == 1) break;
                    //})
                    //);
                    DoEvents();
                }
